#' @title gph function
#' @description MCMC routine for the density regression model
#' 
#' @references {Maity, A. K., Pati, D., and Mallick, B. K., (2022). 
#' Bayesian Time-to-event Data Density Regression with Application to High Dimensional Data.}
#' 
#' @param ct survival response, a \eqn{n*2} matrix with first column as response and 
...
#' @param method.mcmc which mcmc routine to employ between two options -- "MH" and "slice". 
#' MH stands for Metropolis Hestings
#' @param prior which prior to specify on the regression parameters between two options --
